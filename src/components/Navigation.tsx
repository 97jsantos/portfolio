...
export function Navigation() {
  ...
  return (
    <nav className="flex items-center justify-around sticky top-0 bg-gray-900 z-20 shadow-sm shadow-white sm:border-b h-14">
      <button 
      ...
      <div className="max-w-7xl w-full relative mx-auto flex items-center justify-around">
        <ul className={`flex flex-col absolute border-t sm:border-t-0 bg-gray-800 sm:bg-gray-900 z-10 w-full top-7 sm:left-auto sm:flex-row justify-center sm:justify-around sm:top-auto duration-500 sm:duration-0 ${isNavExpanded ? "left-0" : "-left-full"}
                    `}>
          ...
          <div className="flex flex-col sm:flex-row">
            ...
            <Link to="skills" spy={true} smooth={true} offset={-56} duration={500} className="px-5 opacity-60 hover:opacity-100 font-medium flex justify-center items-center my-3 mb-6 sm:my-0 cursor-pointer">Habilidades</Link>
          </div>
        </ul>
      </div>
    </nav>
