            ...
            <div className='p-20 flex items-center justify-center backdrop-blur-lg'>
                ...
                <div className='flex flex-col items-center ml-8'>
                    ...
                    <div className='flex mt-4'>
                        ...
                        <a className='flex gap-1 items-center ml-4 hover:scale-110 duration-500' href="https://www.linkedin.com/in/joelisson-santos/" target="_blank" rel="noreferrer"><FaLinkedin style={{fontSize:'20px'}}/>Joélisson Santos</a>
                    </div>
                </div>
            </div>
        </div>
