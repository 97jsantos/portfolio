...
export function Header() {
    return (
        <div id='header' style={{ backgroundImage: `url(${dev})`}} className="mx-auto flex items-center justify-center bg-no-repeat bg-fixed bg-cover lg:bg-center bg-right min-h-screen">
